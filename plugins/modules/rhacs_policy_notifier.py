...
options:
  notifiers:
    description:
      ...
      - See the M(herve4m.rhacs_configuration.rhacs_notifier_integration)
  ...
  ignore_missing:
    description:
      - ignore_missing the notifiers association even if some of the policies
        listed in the O(policies) parameter do not exist.
